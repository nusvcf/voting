	...
	render() {
		return (
			<div className="App">
				...
				{this.state.loggedIn && this.state.userType === 'admin' && <AdminDashboard clearState={this.clearState} />}
				{this.state.loggedIn && this.state.userType === 'user' && <UserDashboard clearState={this.clearState} />}
			</div>
		);
	}
}
