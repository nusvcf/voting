  ...
  render() {
    return (
      <div className="name-item">
        <span onClick={this.props.removeName} className="icon">
  ...
  render() {
    if (this.props.show) {
      let names = this.state.names.map((name, i) => (
        <NameItem key={i} name={name} removeName={() => this.removeName(i)} />
      ));
      return (
        <div className="modal">
            ...
            <form onSubmit={this.handleSubmit}>
              ...
              <div className="input-group">
                ...
                <div className="input-group input-group-row">
                  ...
                  />
                  <button className="btn-secondary" onClick={this.addName}>
                    Add
                  </button>
                </div>
              </div>
